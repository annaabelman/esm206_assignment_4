...
**Figure 3.** Mean lobster sizes (mm) grouped by MPA sites and non-MPA sites in 2012 (green) and 2018 (orange). From 2012-2018, the lobster size increased at MPA sites and decreased at non-MPA sites.
...
At MPA sites, mean lobster sizes increased by `r mpa_pct <- ((mean_MPA_2018 - mean_MPA_2012) / mean_MPA_2012) * 100``r round(mpa_pct, 1)`% while mean lobster sizes decreased by `r nmpa_pct <- ((mean_nMPA_2012 - mean_nMPA_2018) / mean_nMPA_2012) * 100``r round(nmpa_pct, 1)`% at non-MPA sites. We will explore these differences further with statistical tests to determine their significance.



**Table 1.**Statistical summary (mean, standard deviation, and sample size) of the lobster sizes (mm) between MPA and Non-MPA sites in 2012-2018. 
